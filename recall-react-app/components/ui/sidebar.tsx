    ...
    return (
      <div
        ...
        className={cn(
          ...
          state === "collapsed" &&
            collapsible === "offcanvas" &&
            "group-data-[side=left]:-translate-x-full group-data-[side=right]:translate-x-full",
          state === "collapsed" &&
            collapsible === "icon" &&
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full group-data-[collapsible=icon]:flex",
        className
      )}
      {...props}
    />
  ...
  (
    ...
    const button = (
      <Comp
        ...
        data-size={state === "collapsed" ? "icon" : "default"}
...
>(({ className, asChild = false, showOnHover = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-2 top-1.5 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 peer-data-[size=icon]/menu-button:peer-data-[state=collapsed]/menu-button:!hidden [&>svg]:size-4 [&>svg]:shrink-0",
        // Increases the hit area of the button on mobile.
        "after:absolute after:-inset-2 after:md:hidden",
        "peer-data-[size=default]/menu-button:group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "group-focus-within/menu-item:opacity-100 group-hover/menu-item:opacity-100 data-[state=open]:opacity-100 peer-data-[size=icon]/menu-button:opacity-0 peer-data-[size=icon]/menu-button:group-data-[collapsible=icon]:opacity-0",
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "peer-data-[size=icon]/menu-button:peer-data-[state=collapsed]/menu-button:!hidden",
        "peer-data-[size=default]/menu-button:group-data-[collapsible=icon]:hidden",
        "peer-data-[size=icon]/menu-button:translate-x-1 peer-data-[size=icon]/menu-button:scale-0 peer-data-[state=collapsed]/menu-button:peer-data-[size=icon]/menu-button:translate-x-0 peer-data-[state=collapsed]/menu-button:peer-data-[size=icon]/menu-button:scale-100",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <ul
      ...
      className={cn(
        "mx-3.5 mt-0.5 flex min-w-0 flex-col gap-0.5 border-l border-sidebar-border px-2.5 py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
